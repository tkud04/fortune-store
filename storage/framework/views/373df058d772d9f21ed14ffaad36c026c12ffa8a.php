								...
								<div class="single_product">
									<div class="product_image">
										...
										<div class="box-content">
											...
											<a href="javascript:void(0)" onclick="addToCart({xf: '<?php echo e($xf); ?>'})" title="Add to cart"><i class="fa fa-cart-plus"></i></a>
										</div>										
									</div>

									<div class="product_btm_text">
										<h4><a href="<?php echo e($uu); ?>"><?php echo e($p['name']); ?></a></h4>
										<div class="p_rating">
										   <?php for($i = 0; $i < $p['rating']; $i++): ?>
											<i class="fa fa-star"></i>
										   <?php endfor; ?>
										</div>										
										<span class="price">&#8358;<?php echo e(number_format($amt,2)); ?></span>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\fortune-store\resources\views/index.blade.php ENDPATH**/ ?>